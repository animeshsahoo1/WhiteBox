...
class AgenticMemorySystem:
    ...
    def __init__(self, 
        ...
        Args:
            ...
            collection_name: Name of the ChromaDB collection (use unique names to avoid conflicts)
        """
        self.memories = {}
        self.model_name = model_name
        self.collection_name = collection_name
        
        # Create a fresh retriever instance with the specified collection name
        # Using get_or_create_collection internally, no need to reset
        self.retriever = ChromaRetriever(collection_name=self.collection_name, model_name=self.model_name)
    ...
    def consolidate_memories(self):
        ...
        # Reset ChromaDB collection using the stored collection name
        self.retriever = ChromaRetriever(collection_name=self.collection_name, model_name=self.model_name)
